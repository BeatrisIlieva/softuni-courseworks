...
class AddToShoppingCartViewTests(TestCase):
    def setUp(self):
        ...
        self.added_quantity_to_shopping_cart = AddToShoppingCartView.QUANTITY_TO_DECREASE_UPON_ADDING_TO_SHOPPING_CART
    ...
    def test_add_to_shopping_cart(self):
        ...
        self.assertEqual(ShoppingCart.objects.count(),
                         initial_shopping_cart_obj_count + self.added_quantity_to_shopping_cart)
