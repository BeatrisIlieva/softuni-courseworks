    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('R', 'Rally'), ('OW', 'Open-wheel'), ('K', 'Kart'), ('D', 'Drag'), ('O', 'Other')], max_length=10)),
                ('model', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(1)])),
                ('year', models.IntegerField(validators=[worldOfSpeedApp.cars.validators.RangeValidator()])),
