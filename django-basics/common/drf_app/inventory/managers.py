...
from drf_app.utils.queries.get_full_category_title import (
    get_full_category_title,
)
from drf_app.utils.queries.get_full_color_title import (
    get_full_color_title,
)
from drf_app.utils.queries.get_stock_status_per_size import (
    get_stock_status_per_size,
)
from drf_app.utils.queries.get_stock_status_for_all_sizes import (
