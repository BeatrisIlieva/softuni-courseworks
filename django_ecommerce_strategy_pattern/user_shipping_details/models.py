...
class UserShippingDetails(BaseCreateCharField):

    first_name = BaseCreateCharField.create_char_field(
    ...
    last_name = BaseCreateCharField.create_char_field(
    ...
    phone_number = BaseCreateCharField.create_char_field(
    ...
    country = BaseCreateCharField.create_char_field(
    ...
    city = BaseCreateCharField.create_char_field(
    ...
    street_address = BaseCreateCharField.create_char_field(
    ...
    apartment = BaseCreateCharField.create_char_field(
